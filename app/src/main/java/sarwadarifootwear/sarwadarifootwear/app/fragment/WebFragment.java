package sarwadarifootwear.sarwadarifootwear.app.fragment;
...
import sarwadarifootwear.sarwadarifootwear.app.util.GetFileInfo;
import sarwadarifootwear.sarwadarifootwear.app.R;
import sarwadarifootwear.sarwadarifootwear.app.widget.webview.WebToAppChromeClient;
...
import sarwadarifootwear.sarwadarifootwear.app.widget.AdvancedWebView;
import sarwadarifootwear.sarwadarifootwear.app.widget.scrollable.ToolbarWebViewScrollListener;
...
//https://www.fiverr.com/zuhaib88
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = (GifImageView) rl.findViewById(R.id.progressbar);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (information.PULL_TO_REFRESH)
     ...
     //   browser.getSettings().setAppCacheEnabled(true);
        ...
        browser.getSettings().setUserAgentString("THINGS I DO");

  //      browser.getSettings().setUserAgentString("NewsSocial Staging android app");
